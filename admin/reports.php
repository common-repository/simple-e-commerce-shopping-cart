...
<?php 
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST') 
	{
	    if(isset($_POST['simpleecommcart-task']) && $_POST['simpleecommcart-task'] == 'general sales') {
            // @since 3.1.2
            SimpleEcommNonce::verify_admin_nonce(SimpleEcommNonce::$general_sales_nonce);

			 $data=$_POST['general'];
			 $general_sales_overview_start_date = sanitize_text_field($data["start_date"]);
			 $general_sales_overview_end_date   = sanitize_text_field($data["end_date"]);
		 	...
		 	// @since 3.1.2
		 	SimpleEcommNonce::verify_admin_nonce(SimpleEcommNonce::$individual_product_sales_nonce);

            $data=$_POST['individual'];
			$individual_selected_month = sanitize_text_field($data["month"]);
			$individual_selected_year  = sanitize_text_field($data["year"]);
		}
	}
?>
<h2>Reports</h2>
			...
			<form class='phorm' action="" method="post">
				 	...
				 	<table  style="width:100%;">
					 	<tr>
							...
							<td>
                                <?php SimpleEcommNonce::nonce_field(SimpleEcommNonce::$general_sales_nonce); ?>
		...
		<div class="widgets-holder-wrap">
			<div class="sidebar-name"> 
       		...
       		<div class="widget-holder">
				...
				<?php
                    // @since 3.1.2
                if(isset($_POST['showreport']) && isset($_POST['monthly_sales_current_year'])){
                    SimpleEcommNonce::verify_admin_nonce(SimpleEcommNonce::$monthy_sales_report_nonce);
                }
				...
				<table>
					<tr>
						...
						<td>
                            <?php SimpleEcommNonce::nonce_field(SimpleEcommNonce::$monthy_sales_report_nonce); ?>
			...
			<div class="sidebar-name"> 
       		...
       		<div class="widget-holder">
				...
				<?php
                  ...
                  if(isset($_POST['showReportDailySales'])){
                      SimpleEcommNonce::verify_admin_nonce(SimpleEcommNonce::$daily_sales_report_nonce);
                  }
				...
				<table style="width:100px;">
					 	<tr>
							...
							<td>
                                <?php SimpleEcommNonce::nonce_field(SimpleEcommNonce::$daily_sales_report_nonce); ?>
							...
							<td>
								 <select name="individual[year]">
									...
									<option value="2020" <?php echo  $individual_selected_year==2020?'selected':''?>>2020</option>
                                     <option value="2021" <?php echo  $individual_selected_year==2020?'selected':''?>>2021</option>
                                     <option value="2022" <?php echo  $individual_selected_year==2020?'selected':''?>>2022</option>
                                     <option value="2023" <?php echo  $individual_selected_year==2020?'selected':''?>>2023</option>
								 </select>
							</td>
							<td>
                                <?php SimpleEcommNonce::nonce_field(SimpleEcommNonce::$individual_product_sales_nonce); ?>
								<input name="showReport" type="submit" value="Show Report"/>
							</td>
						</tr>
				</table>

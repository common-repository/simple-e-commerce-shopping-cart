...
if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit'])) {
    SimpleEcommNonce::verify_admin_nonce(SimpleEcommNonce::$tax_save_nonce);

	if( $_POST['simpleecommcart-action'] == 'saveTaxSettings')
	{
		$_POST['tax_settings']['flat_rate'] = sanitize_text_field($_POST['tax_settings']['flat_rate']);
...
<div class='wrap' style="width:80%;max-width:80%;float:left;"> 
	...
	<br>
     <?php  SimpleEcommNonce::nonce_field(SimpleEcommNonce::$tax_save_nonce); ?>

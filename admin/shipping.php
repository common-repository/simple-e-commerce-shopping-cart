...
if($_SERVER['REQUEST_METHOD'] == "POST") {
  if(isset($_POST['simpleecommcart-action']) && $_POST['simpleecommcart-action'] == 'save flat rate options') {
  	SimpleEcommNonce::verify_admin_nonce(SimpleEcommNonce::$shipping_save_nonce);
 ...
 <div id="widgets-left" style="margin-right: 5px;">
    <div id="available-widgets"> 
		...
		<table>
            ...
            <?php SimpleEcommNonce::nonce_field(SimpleEcommNonce::$shipping_save_nonce); ?>
